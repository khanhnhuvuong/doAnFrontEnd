    ...
    const createRoom = () => {
        ...
        socket.onmessage = (event) => {
            ...
            if (response.status === 'success' && response.event === 'CREATE_ROOM') {
                // <Alert message="Create room successfully!" type="success" showIcon />;
        ...
        const joinRoom = () => {
            ...
            socket.onmessage = (event) => {
                ...
                if (response.status === 'success' && response.event === 'JOIN_ROOM') {
                    // <Alert message="Join room successfully!" type="success" showIcon />;
                    ...
                    <div className="d-flex flex-row m-2">
                        ...
                        <div className="pt-1" style={{marginTop: '5px'}}>
                            <h4 className="fw-bold font mb-0"
                                style={{color: '#3b71ca'}}>{sessionStorage.getItem('user')}</h4>
                        </div>
                    </div>
                                            ...
                                            <div className="d-flex flex-row">
                                                ...
                                                <div className="pt-1">
                                                    <p className="fw-bold mt-3"
                                                       style={{color: '#3b71ca'}}>{user.name}</p>
